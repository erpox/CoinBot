...
public class Worker extends SwingWorker<Boolean, String>
{
    ...
    protected void compraTickets() {
        if (this.ticketCount[this.selector] == 0) {
            ...
            Worker.driver.findElement(By.linkText("LOTTERY")).click();
            Worker.driver.findElement(By.id("lottery_tickets_purchase_count")).clear();
            Worker.driver.findElement(By.id("lottery_tickets_purchase_count")).sendKeys(new CharSequence[] { cantidadTickets });
            try {
                Worker.driver.findElement(By.linkText("Got it!")).click();
            }
            catch (NoSuchElementException ex) {}
            Worker.driver.findElement(By.id("purchase_lottery_tickets_button")).click();
            Worker.driver.findElement(By.linkText("FREE BTC")).click();
    ...
    protected void Inicializar(final String Perfil) throws WebDriverException, InterruptedException {
        ...
        Worker.driver = (WebDriver)new FirefoxDriver(options);
        Worker.driver.manage().window().maximize();
        this.model.setValueAt(" Cargando https://freebitco.in/", this.selector, 14);
        try {
            Worker.driver.manage().timeouts().pageLoadTimeout(60L, TimeUnit.SECONDS);
            Worker.driver.get("https://freebitco.in");
        }
    ...
    protected void loadSite() throws InterruptedException, NoSuchSessionException, WebDriverException {
        try {
            Worker.balanceBTC = Worker.driver.findElement(By.id("balance")).getText();
        }
        ...
        final String porcentaje = Worker.driver.findElement(By.id("fp_bonus_req_completed")).getText().substring(0, 6);
        this.model.setValueAt(porcentaje, this.selector, 4);
        Worker.driver.findElement(By.linkText("REWARDS")).click();
        Worker.balancePuntos = Worker.driver.findElement(By.xpath("//div[@id='rewards_tab']/div[2]/div/div[2]")).getText();
        final String newStr = Worker.balancePuntos.replace(",", "").trim();
        try {
            Worker.balancePuntosParse = Integer.parseInt(newStr);
        }
        catch (NumberFormatException e2) {
            Worker.balancePuntosParse = 1000;
        }
        this.finalPuntos = Worker.balancePuntosParse;
        Worker.driver.findElement(By.linkText("FREE BTC")).click();
        if (Worker.driver.findElement(By.id("time_remaining")).isDisplayed()) {
            final String timeRemaining = Worker.driver.findElement(By.id("time_remaining")).getText();
            String hora = "";
            try {
            ...
            this.nextRollArray[this.selector] = this.now;
            try {
                final String bonu = Worker.driver.findElement(By.xpath("//div[@id='bonus_container_free_points']/p/span")).getText().substring(0, 3).trim();
                Worker.bonoRPFin = Worker.driver.findElement(By.id("bonus_span_free_points")).getText().substring(0, 2) + " Hrs";
                if (bonu.contains("e")) {
                    Worker.bonusRewarP = bonu.replace("e", "") + "RP";
                }
                else {
                    Worker.bonusRewarP = bonu + " RP";
                }
            }
            catch (NoSuchElementException ex) {
                Worker.bonusRewarP = "No";
            }
            ...
            try {
                final String bonuBTC = Worker.driver.findElement(By.id("bonus_container_fp_bonus")).getText().substring(13, 17);
                Worker.bonoBTCFin = Worker.driver.findElement(By.id("bonus_span_fp_bonus")).getText().substring(0, 2) + " Hrs";
                if (bonuBTC.contains("F")) {
                    Worker.bonusFreeBTC = bonuBTC.replace("F", "");
                }
                else if (bonuBTC.contains("1000")) {
                    Worker.bonusFreeBTC = bonuBTC + "%";
                }
                else {
                    Worker.bonusFreeBTC = bonuBTC;
                }
                ...
                Worker.bonusFreeBTC = "No";
                Worker.bonoBTCFin = " - ";
            }
            final double balanceParse = Double.parseDouble(Worker.balanceBTC) * 1.0E8;
            ...
            this.model.setValueAt(String.format("%,d", Worker.balancePuntosParse), this.selector, 3);
            this.model.setValueAt(0, this.selector, 5);
            this.model.setValueAt(0, this.selector, 6);
            this.model.setValueAt(Worker.bonusRewarP, this.selector, 8);
            this.model.setValueAt(Worker.bonoRPFin, this.selector, 9);
            this.model.setValueAt(Worker.bonusFreeBTC, this.selector, 11);
            this.model.setValueAt(Worker.bonoBTCFin, this.selector, 12);
            this.model.setValueAt(hora, this.selector, 13);
            if (Worker.driver.findElement(By.id("multi_acct_same_ip")).isDisplayed()) {
    ...
    protected void activarBonusPuntos() throws InterruptedException {
        ...
        if (this.finalPuntos >= 12 && this.finalPuntos < 120) {
            this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[6]/div", "//button[@onclick=\"RedeemRPProduct('free_points_1')\"]", Worker.bonoRPFin);
            this.finalPuntos -= 12;
            Worker.bonusRewarP = "1 RP";
        }
        Label_0466: {
            switch (this.tipoBono[0]) {
                case 0: {
                    if (this.finalPuntos >= 1200) {
                        this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[6]/div", "//button[@onclick=\"RedeemRPProduct('free_points_100')\"]", Worker.bonoRPFin);
                        this.finalPuntos -= 1200;
                        Worker.bonusRewarP = "100 RP";
                        break;
                    }
                    if (this.finalPuntos >= 600) {
                        this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[6]/div", "//button[@onclick=\"RedeemRPProduct('free_points_50')\"]", Worker.bonoRPFin);
                        this.finalPuntos -= 600;
                        Worker.bonusRewarP = "50 RP";
                        break;
                    }
                    if (this.finalPuntos >= 300) {
                        this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[6]/div", "//button[@onclick=\"RedeemRPProduct('free_points_25')\"]", Worker.bonoRPFin);
                        this.finalPuntos -= 300;
                        Worker.bonusRewarP = "25 RP";
                        break;
                    }
                    if (this.finalPuntos >= 120) {
                        this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[6]/div", "//button[@onclick=\"RedeemRPProduct('free_points_10')\"]", Worker.bonoRPFin);
                        this.finalPuntos -= 120;
                        Worker.bonusRewarP = "10 RP";
                        break;
                    }
                    Worker.bonoRPFin = " - ";
                    Worker.bonusRewarP = "No";
    ...
    protected void activarBonusFreeBTC() throws InterruptedException {
        ...
        if (this.finalPuntos >= 32 && this.finalPuntos < 160) {
            this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[4]/div", "//button[@onclick=\"RedeemRPProduct('fp_bonus_10')\"]", Worker.bonoBTCFin);
            this.finalPuntos -= 32;
            Worker.bonusFreeBTC = "10%";
        }
        switch (this.tipoBono[1]) {
            case 0: {
                if (this.finalPuntos >= 3200) {
                    this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[4]/div", "//button[@onclick=\"RedeemRPProduct('fp_bonus_1000')\"]", Worker.bonoBTCFin);
                    this.finalPuntos -= 3200;
                    Worker.bonusFreeBTC = "1000%";
                    break;
                }
                if (this.finalPuntos >= 1600) {
                    this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[4]/div", "//button[@onclick=\"RedeemRPProduct('fp_bonus_500')\"]", Worker.bonoBTCFin);
                    this.finalPuntos -= 1600;
                    Worker.bonusFreeBTC = "500%";
                    break;
                }
                if (this.finalPuntos >= 320) {
                    this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[4]/div", "//button[@onclick=\"RedeemRPProduct('fp_bonus_100')\"]", Worker.bonoBTCFin);
                    this.finalPuntos -= 320;
                    Worker.bonusFreeBTC = "100%";
                    break;
                }
                if (this.finalPuntos >= 160) {
                    this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[4]/div", "//button[@onclick=\"RedeemRPProduct('fp_bonus_50')\"]", Worker.bonoBTCFin);
                    this.finalPuntos -= 160;
                    Worker.bonusFreeBTC = "50%";
                    break;
                }
                Worker.bonoBTCFin = " - ";
                Worker.bonusFreeBTC = "No";
    ...
    protected void rollAction() throws IOException, InterruptedException, NoSuchSessionException {
        ...
        boolean invi;
        try {
            invi = Worker.driver.findElement(By.className("grecaptcha-badge")).isDisplayed();
        }
        ...
        Worker.responseToken = TwoCaptchaFreeBTC.Tokenizer();
        System.out.println(Worker.responseToken);
        if (Worker.responseToken.contains("ERROR_WRONG_USER_KEY")) {
            this.model.setValueAt(" 2Captcha API Key invalido", this.selector, 14);
            this.killDriver();
        }
        else if (Worker.responseToken.contains("ERROR_RECAPTCHA_TIMEOUT") & this.captchaCount >= 1) {
            do {
        ...
        else if (Worker.responseToken.contains("ERROR_PROXY_BANNED")) {
            do {
                final int range = this.model.getRowCount() - 0 + 1;
                this.proxySelector = (int)(Math.random() * range + 0.0);
            } while (this.proxySelector == this.selector);
        ...
        final JavascriptExecutor jse = (JavascriptExecutor)Worker.driver;
        if (invi) {
            System.out.println("Captcha invisible");
            jse.executeScript("document.getElementById('g-recaptcha-response').innerHTML='" + Worker.responseToken + "';", new Object[0]);
            jse.executeScript("window.submit_fp_rec_inv();", new Object[0]);
        }
        else {
            jse.executeScript("document.getElementById('g-recaptcha-response').value='" + Worker.responseToken + "';", new Object[0]);
            try {
                Worker.driver.findElement(By.linkText("Got it!")).click();
            }
            catch (NoSuchElementException ex) {}
            try {
                Worker.driver.findElement(By.id("free_play_form_button")).click();
            }
            catch (ElementNotInteractableException ex2) {}
        }
        Thread.sleep(2000L);
        if (Worker.driver.findElement(By.id("free_play_error")).isDisplayed()) {
            if (Worker.driver.findElement(By.id("free_play_error")).getText().equals("Sorry, this IP address has been blocked. If you are using a proxy, VPN or anonymization service, please turn it off before claiming free bitcoins.")) {
                this.ipBaned();
            }
            else if (Worker.driver.findElement(By.id("free_play_error")).getText().equals("Captcha is incorrect or has expired. Please try again.")) {
                ++this.captchaCount;
                this.rollAction();
            }
            else if (Worker.driver.findElement(By.id("free_play_error")).getText().contains("You need to verify your email before you can play the FREE BTC game.")) {
        ...
        try {
            final WebDriverWait wait = new WebDriverWait(Worker.driver, 5L);
            ...
            Logger.getLogger(Worker.class.getName()).log(Level.SEVERE, null, e);
            Worker.driver.navigate().refresh();
            this.rollAction();
        }
        Worker.postRoll = Worker.driver.findElement(By.id("winnings")).getText();
        Worker.rewardPointRoll = Worker.driver.findElement(By.id("fp_reward_points_won")).getText();
        final int rp = Integer.parseInt(Worker.rewardPointRoll);
        this.finalPuntos += rp;
    ...
    protected void postear() throws InterruptedException, NoSuchSessionException {
        ...
        double finall = 0.0;
        final double balanceParse = Double.parseDouble(Worker.balanceBTC);
        if (!Worker.postRoll.isEmpty()) {
            final double balroll = Double.parseDouble(Worker.postRoll);
            finall = (balanceParse + balroll) * 1.0E8;
            final int balance2 = (int)finall;
            this.model.setValueAt(String.format("%,d", balance2), this.selector, 2);
            this.balanceRoll = Worker.postRoll.replace(".", "0");
        ...
        this.model.setValueAt(Worker.rewardPointRoll, this.selector, 6);
        this.model.setValueAt(Worker.bonoRPFin, this.selector, 9);
        this.model.setValueAt(Worker.bonoBTCFin, this.selector, 12);
        this.model.setValueAt(Worker.bonusRewarP, this.selector, 8);
        this.model.setValueAt(Worker.bonusFreeBTC, this.selector, 11);
    ...
    protected void freeRollPlay() throws NoSuchSessionException, InterruptedException, IOException {
        ...
        try {
            Worker.driver.findElement(By.className("g-recaptcha"));
            this.rollAction();
        }
        catch (NoSuchElementException e) {
            this.sinCaptpcha();
    ...
    public void activarBonos(final String banner, final String bono, String tipoBono) {
        Worker.driver.findElement(By.linkText("REWARDS")).click();
        Worker.driver.findElement(By.xpath(banner)).click();
        Worker.driver.findElement(By.xpath(bono)).click();
        tipoBono = "24 Hrs";
    }
    
    static {
        Worker.balancePuntos = "";
        Worker.balancePuntosParse = 0;
        Worker.balanceBTC = "";
        Worker.bonoRPFin = " - ";
        Worker.bonoBTCFin = " - ";
        Worker.postRoll = "";
        Worker.rewardPointRoll = "";
    }
}
