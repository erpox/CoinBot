...
public class Worker6 extends SwingWorker<Boolean, String> {
    ...
    public Worker6 (String perfil, int selector, DefaultTableModel model,
            ...
            JCheckBoxMenuItem checkBonusRP, JCheckBoxMenuItem checkBonusBTC, ArrayList<Proxies> proxies) throws IOException {
