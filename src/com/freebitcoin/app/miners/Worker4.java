...
public class Worker4 extends SwingWorker<Boolean, String>
{
    ...
    protected void compraTickets() {
        if (this.ticketCount[this.selector] == 0) {
            ...
            Worker4.driver.findElement(By.linkText("LOTTERY")).click();
            Worker4.driver.findElement(By.id("lottery_tickets_purchase_count")).clear();
            Worker4.driver.findElement(By.id("lottery_tickets_purchase_count")).sendKeys(new CharSequence[] { cantidadTickets });
            try {
                Worker4.driver.findElement(By.linkText("Got it!")).click();
            }
            catch (NoSuchElementException ex) {}
            Worker4.driver.findElement(By.id("purchase_lottery_tickets_button")).click();
            Worker4.driver.findElement(By.linkText("FREE BTC")).click();
    ...
    protected void Inicializar(final String Perfil) throws WebDriverException, InterruptedException {
        ...
        Worker4.driver = (WebDriver)new FirefoxDriver(options);
        Worker4.driver.manage().window().maximize();
        this.model.setValueAt(" Cargando https://freebitco.in/", this.selector, 14);
        try {
            Worker4.driver.manage().timeouts().pageLoadTimeout(60L, TimeUnit.SECONDS);
            Worker4.driver.get("https://freebitco.in");
        }
    ...
    protected void loadSite() throws InterruptedException, NoSuchSessionException, WebDriverException {
        try {
            Worker4.balanceBTC = Worker4.driver.findElement(By.id("balance")).getText();
        }
        ...
        final String porcentaje = Worker4.driver.findElement(By.id("fp_bonus_req_completed")).getText().substring(0, 6);
        this.model.setValueAt(porcentaje, this.selector, 4);
        Worker4.driver.findElement(By.linkText("REWARDS")).click();
        Worker4.balancePuntos = Worker4.driver.findElement(By.xpath("//div[@id='rewards_tab']/div[2]/div/div[2]")).getText();
        final String newStr = Worker4.balancePuntos.replace(",", "").trim();
        try {
            Worker4.balancePuntosParse = Integer.parseInt(newStr);
        }
        catch (NumberFormatException e2) {
            Worker4.balancePuntosParse = 1000;
        }
        this.finalPuntos = Worker4.balancePuntosParse;
        Worker4.driver.findElement(By.linkText("FREE BTC")).click();
        if (Worker4.driver.findElement(By.id("time_remaining")).isDisplayed()) {
            final String timeRemaining = Worker4.driver.findElement(By.id("time_remaining")).getText();
            String hora = "";
            try {
            ...
            this.nextRollArray[this.selector] = this.now;
            try {
                final String bonu = Worker4.driver.findElement(By.xpath("//div[@id='bonus_container_free_points']/p/span")).getText().substring(0, 3).trim();
                Worker4.bonoRPFin = Worker4.driver.findElement(By.id("bonus_span_free_points")).getText().substring(0, 2) + " Hrs";
                if (bonu.contains("e")) {
                    Worker4.bonusRewarP = bonu.replace("e", "") + "RP";
                }
                else {
                    Worker4.bonusRewarP = bonu + " RP";
                }
            }
            catch (NoSuchElementException ex) {
                Worker4.bonusRewarP = "No";
            }
            ...
            try {
                final String bonuBTC = Worker4.driver.findElement(By.id("bonus_container_fp_bonus")).getText().substring(13, 17);
                Worker4.bonoBTCFin = Worker4.driver.findElement(By.id("bonus_span_fp_bonus")).getText().substring(0, 2) + " Hrs";
                if (bonuBTC.contains("F")) {
                    Worker4.bonusFreeBTC = bonuBTC.replace("F", "");
                }
                else if (bonuBTC.contains("1000")) {
                    Worker4.bonusFreeBTC = bonuBTC + "%";
                }
                else {
                    Worker4.bonusFreeBTC = bonuBTC;
                }
                ...
                Worker4.bonusFreeBTC = "No";
                Worker4.bonoBTCFin = " - ";
            }
            final double balanceParse = Double.parseDouble(Worker4.balanceBTC) * 1.0E8;
            ...
            this.model.setValueAt(String.format("%,d", Worker4.balancePuntosParse), this.selector, 3);
            this.model.setValueAt(0, this.selector, 5);
            this.model.setValueAt(0, this.selector, 6);
            this.model.setValueAt(Worker4.bonusRewarP, this.selector, 8);
            this.model.setValueAt(Worker4.bonoRPFin, this.selector, 9);
            this.model.setValueAt(Worker4.bonusFreeBTC, this.selector, 11);
            this.model.setValueAt(Worker4.bonoBTCFin, this.selector, 12);
            this.model.setValueAt(hora, this.selector, 13);
            if (Worker4.driver.findElement(By.id("multi_acct_same_ip")).isDisplayed()) {
    ...
    protected String checkBonusFreeBTC() throws InterruptedException {
        ...
        try {
            ...
            Worker4.bonusFreeBTC = " - ";
            Worker4.bonoBTCFin = " - ";
        }
        return Worker4.bonusFreeBTC;
    }
    ...
    protected void activarBonusPuntos() throws InterruptedException {
        ...
        if (this.finalPuntos >= 12 && this.finalPuntos < 120) {
            this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[6]/div", "//button[@onclick=\"RedeemRPProduct('free_points_1')\"]", Worker4.bonoRPFin);
            this.finalPuntos -= 12;
            Worker4.bonusRewarP = "1 RP";
        }
        Label_0466: {
            switch (this.tipoBono[0]) {
                case 0: {
                    if (this.finalPuntos >= 1200) {
                        this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[6]/div", "//button[@onclick=\"RedeemRPProduct('free_points_100')\"]", Worker4.bonoRPFin);
                        this.finalPuntos -= 1200;
                        Worker4.bonusRewarP = "100 RP";
                        break;
                    }
                    if (this.finalPuntos >= 600) {
                        this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[6]/div", "//button[@onclick=\"RedeemRPProduct('free_points_50')\"]", Worker4.bonoRPFin);
                        this.finalPuntos -= 600;
                        Worker4.bonusRewarP = "50 RP";
                        break;
                    }
                    if (this.finalPuntos >= 300) {
                        this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[6]/div", "//button[@onclick=\"RedeemRPProduct('free_points_25')\"]", Worker4.bonoRPFin);
                        this.finalPuntos -= 300;
                        Worker4.bonusRewarP = "25 RP";
                        break;
                    }
                    if (this.finalPuntos >= 120) {
                        this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[6]/div", "//button[@onclick=\"RedeemRPProduct('free_points_10')\"]", Worker4.bonoRPFin);
                        this.finalPuntos -= 120;
                        Worker4.bonusRewarP = "10 RP";
                        break;
                    }
                    Worker4.bonoRPFin = " - ";
                    Worker4.bonusRewarP = "No";
    ...
    protected void activarBonusFreeBTC() throws InterruptedException {
        ...
        if (this.finalPuntos >= 32 && this.finalPuntos < 160) {
            this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[4]/div", "//button[@onclick=\"RedeemRPProduct('fp_bonus_10')\"]", Worker4.bonoBTCFin);
            this.finalPuntos -= 32;
            Worker4.bonusFreeBTC = "10%";
        }
        switch (this.tipoBono[1]) {
            case 0: {
                if (this.finalPuntos >= 3200) {
                    this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[4]/div", "//button[@onclick=\"RedeemRPProduct('fp_bonus_1000')\"]", Worker4.bonoBTCFin);
                    this.finalPuntos -= 3200;
                    Worker4.bonusFreeBTC = "1000%";
                    break;
                }
                if (this.finalPuntos >= 1600) {
                    this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[4]/div", "//button[@onclick=\"RedeemRPProduct('fp_bonus_500')\"]", Worker4.bonoBTCFin);
                    this.finalPuntos -= 1600;
                    Worker4.bonusFreeBTC = "500%";
                    break;
                }
                if (this.finalPuntos >= 320) {
                    this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[4]/div", "//button[@onclick=\"RedeemRPProduct('fp_bonus_100')\"]", Worker4.bonoBTCFin);
                    this.finalPuntos -= 320;
                    Worker4.bonusFreeBTC = "100%";
                    break;
                }
                if (this.finalPuntos >= 160) {
                    this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[4]/div", "//button[@onclick=\"RedeemRPProduct('fp_bonus_50')\"]", Worker4.bonoBTCFin);
                    this.finalPuntos -= 160;
                    Worker4.bonusFreeBTC = "50%";
                    break;
                }
                Worker4.bonoBTCFin = " - ";
                Worker4.bonusFreeBTC = "No";
    ...
    protected void rollAction() throws IOException, InterruptedException, NoSuchSessionException {
        ...
        boolean invi;
        try {
            invi = Worker4.driver.findElement(By.className("grecaptcha-badge")).isDisplayed();
        }
        ...
        Worker4.responseToken = TwoCaptchaFreeBTC.Tokenizer();
        System.out.println(Worker4.responseToken);
        if (Worker4.responseToken.contains("ERROR_WRONG_USER_KEY")) {
            this.model.setValueAt(" 2Captcha API Key invalido", this.selector, 14);
            this.killDriver();
        }
        else if (Worker4.responseToken.contains("ERROR_RECAPTCHA_TIMEOUT") & this.captchaCount >= 1) {
            do {
        ...
        else if (Worker4.responseToken.contains("ERROR_PROXY_BANNED")) {
            do {
                final int range = this.model.getRowCount() - 0 + 1;
                this.proxySelector = (int)(Math.random() * range + 0.0);
            } while (this.proxySelector == this.selector);
        ...
        final JavascriptExecutor jse = (JavascriptExecutor)Worker4.driver;
        if (invi) {
            System.out.println("Captcha invisible");
            jse.executeScript("document.getElementById('g-recaptcha-response').innerHTML='" + Worker4.responseToken + "';", new Object[0]);
            jse.executeScript("window.submit_fp_rec_inv();", new Object[0]);
        }
        else {
            jse.executeScript("document.getElementById('g-recaptcha-response').value='" + Worker4.responseToken + "';", new Object[0]);
            try {
                Worker4.driver.findElement(By.linkText("Got it!")).click();
            }
            catch (NoSuchElementException ex) {}
            try {
                Worker4.driver.findElement(By.id("free_play_form_button")).click();
            }
            catch (ElementNotInteractableException ex2) {}
        }
        Worker4.balanceBTC = Worker4.driver.findElement(By.id("balance")).getText();
        Thread.sleep(2000L);
        if (Worker4.driver.findElement(By.id("free_play_error")).isDisplayed()) {
            if (Worker4.driver.findElement(By.id("free_play_error")).getText().equals("Sorry, this IP address has been blocked. If you are using a proxy, VPN or anonymization service, please turn it off before claiming free bitcoins.")) {
                this.ipBaned();
            }
            else if (Worker4.driver.findElement(By.id("free_play_error")).getText().equals("Captcha is incorrect or has expired. Please try again.")) {
                ++this.captchaCount;
                this.rollAction();
            }
            else if (Worker4.driver.findElement(By.id("free_play_error")).getText().contains("You need to verify your email before you can play the FREE BTC game.")) {
        ...
        try {
            final WebDriverWait wait = new WebDriverWait(Worker4.driver, 5L);
            ...
            Logger.getLogger(Worker.class.getName()).log(Level.SEVERE, null, e);
            Worker4.driver.navigate().refresh();
            this.rollAction();
        }
        Worker4.postRoll = Worker4.driver.findElement(By.id("winnings")).getText();
        Worker4.rewardPointRoll = Worker4.driver.findElement(By.id("fp_reward_points_won")).getText();
        final int rp = Integer.parseInt(Worker4.rewardPointRoll);
        this.finalPuntos += rp;
        this.model.setValueAt(" Esperando siguiente ronda", this.selector, 14);
    }
    ...
    protected void postear() throws InterruptedException, NoSuchSessionException {
        ...
        double finall = 0.0;
        final double balanceParse = Double.parseDouble(Worker4.balanceBTC);
        if (!Worker4.postRoll.isEmpty()) {
            final double balroll = Double.parseDouble(Worker4.postRoll);
            finall = (balanceParse + balroll) * 1.0E8;
            final int balance2 = (int)finall;
            this.model.setValueAt(String.format("%,d", balance2), this.selector, 2);
            this.balanceRoll = Worker4.postRoll.replace(".", "0");
        ...
        this.model.setValueAt(Worker4.rewardPointRoll, this.selector, 6);
        this.model.setValueAt(Worker4.bonoRPFin, this.selector, 9);
        this.model.setValueAt(Worker4.bonoBTCFin, this.selector, 12);
        this.model.setValueAt(Worker4.bonusRewarP, this.selector, 8);
        this.model.setValueAt(Worker4.bonusFreeBTC, this.selector, 11);
    ...
    protected void freeRollPlay() throws NoSuchSessionException, InterruptedException, IOException {
        ...
        try {
            Worker4.driver.findElement(By.className("g-recaptcha"));
            this.rollAction();
        }
        catch (NoSuchElementException e) {
            this.sinCaptpcha();
    ...
    public void activarBonos(final String banner, final String bono, String tipoBono) {
        Worker4.driver.findElement(By.linkText("REWARDS")).click();
        Worker4.driver.findElement(By.xpath(banner)).click();
        Worker4.driver.findElement(By.xpath(bono)).click();
        tipoBono = "24 Hrs";
    }
    
    static {
        Worker4.balancePuntos = "";
        Worker4.balancePuntosParse = 0;
        Worker4.balanceBTC = "";
        Worker4.bonoRPFin = " - ";
        Worker4.bonoBTCFin = " - ";
        Worker4.postRoll = "";
        Worker4.rewardPointRoll = "";
    }
}
