...
public class SilentWorker2 extends SwingWorker<Boolean, String>
{
    ...
    protected void compraTickets() {
        if (this.ticketCount[this.selector] == 0) {
            ...
            SilentWorker2.driver.findElement(By.linkText("LOTTERY")).click();
            SilentWorker2.driver.findElement(By.id("lottery_tickets_purchase_count")).clear();
            SilentWorker2.driver.findElement(By.id("lottery_tickets_purchase_count")).sendKeys(new CharSequence[] { cantidadTickets });
            try {
                SilentWorker2.driver.findElement(By.linkText("Got it!")).click();
            }
            catch (NoSuchElementException ex) {}
            SilentWorker2.driver.findElement(By.id("purchase_lottery_tickets_button")).click();
            SilentWorker2.driver.findElement(By.linkText("FREE BTC")).click();
    ...
    protected void Inicializar(final String Perfil) throws WebDriverException, InterruptedException {
        ...
        SilentWorker2.driver = (WebDriver)new FirefoxDriver(options);
        SilentWorker2.driver.manage().window().maximize();
        this.model.setValueAt(" Cargando https://freebitco.in/", this.selector, 14);
        try {
            SilentWorker2.driver.manage().timeouts().pageLoadTimeout(60L, TimeUnit.SECONDS);
            SilentWorker2.driver.get("https://freebitco.in");
        }
    ...
    protected void loadSite() throws InterruptedException, NoSuchSessionException, WebDriverException {
        try {
            SilentWorker2.balanceBTC = SilentWorker2.driver.findElement(By.id("balance")).getText();
        }
        ...
        final String porcentaje = SilentWorker2.driver.findElement(By.id("fp_bonus_req_completed")).getText().substring(0, 6);
        this.model.setValueAt(porcentaje, this.selector, 4);
        SilentWorker2.driver.findElement(By.linkText("REWARDS")).click();
        SilentWorker2.balancePuntos = SilentWorker2.driver.findElement(By.xpath("//div[@id='rewards_tab']/div[2]/div/div[2]")).getText();
        final String newStr = SilentWorker2.balancePuntos.replace(",", "").trim();
        try {
            SilentWorker2.balancePuntosParse = Integer.parseInt(newStr);
        }
        catch (NumberFormatException e2) {
            SilentWorker2.balancePuntosParse = 1000;
        }
        this.finalPuntos = SilentWorker2.balancePuntosParse;
        SilentWorker2.driver.findElement(By.linkText("FREE BTC")).click();
        if (SilentWorker2.driver.findElement(By.id("time_remaining")).isDisplayed()) {
            final String timeRemaining = SilentWorker2.driver.findElement(By.id("time_remaining")).getText();
            String hora = "";
            try {
            ...
            this.nextRollArray[this.selector] = this.now;
            try {
                final String bonu = SilentWorker2.driver.findElement(By.xpath("//div[@id='bonus_container_free_points']/p/span")).getText().substring(0, 3).trim();
                SilentWorker2.bonoRPFin = SilentWorker2.driver.findElement(By.id("bonus_span_free_points")).getText().substring(0, 2) + " Hrs";
                if (bonu.contains("e")) {
                    SilentWorker2.bonusRewarP = bonu.replace("e", "") + "RP";
                }
                else {
                    SilentWorker2.bonusRewarP = bonu + " RP";
                }
            }
            catch (NoSuchElementException ex) {
                SilentWorker2.bonusRewarP = "No";
            }
            catch (StringIndexOutOfBoundsException ex2) {
                SilentWorker2.bonusRewarP = "No";
                SilentWorker2.bonoRPFin = " - ";
            }
            try {
                final String bonuBTC = SilentWorker2.driver.findElement(By.id("bonus_container_fp_bonus")).getText().substring(13, 17);
                SilentWorker2.bonoBTCFin = SilentWorker2.driver.findElement(By.id("bonus_span_fp_bonus")).getText().substring(0, 2) + " Hrs";
                if (bonuBTC.contains("F")) {
                    SilentWorker2.bonusFreeBTC = bonuBTC.replace("F", "");
                }
                else if (bonuBTC.contains("1000")) {
                    SilentWorker2.bonusFreeBTC = bonuBTC + "%";
                }
                else {
                    SilentWorker2.bonusFreeBTC = bonuBTC;
                }
                ...
                SilentWorker2.bonusFreeBTC = "No";
                SilentWorker2.bonoBTCFin = " - ";
            }
            final double balanceParse = Double.parseDouble(SilentWorker2.balanceBTC) * 1.0E8;
            ...
            this.model.setValueAt(String.format("%,d", SilentWorker2.balancePuntosParse), this.selector, 3);
            this.model.setValueAt(0, this.selector, 5);
            this.model.setValueAt(0, this.selector, 6);
            this.model.setValueAt(SilentWorker2.bonusRewarP, this.selector, 8);
            this.model.setValueAt(SilentWorker2.bonoRPFin, this.selector, 9);
            this.model.setValueAt(SilentWorker2.bonusFreeBTC, this.selector, 11);
            this.model.setValueAt(SilentWorker2.bonoBTCFin, this.selector, 12);
            this.model.setValueAt(hora, this.selector, 13);
            if (SilentWorker2.driver.findElement(By.id("multi_acct_same_ip")).isDisplayed()) {
    ...
    protected String checkBonusFreeBTC() throws InterruptedException {
        ...
        try {
            ...
            SilentWorker2.bonusFreeBTC = " - ";
            SilentWorker2.bonoBTCFin = " - ";
        }
        return SilentWorker2.bonusFreeBTC;
    }
    ...
    protected void activarBonusPuntos() throws InterruptedException {
        ...
        if (this.finalPuntos >= 12 && this.finalPuntos < 120) {
            this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[6]/div", "//button[@onclick=\"RedeemRPProduct('free_points_1')\"]", SilentWorker2.bonoRPFin);
            this.finalPuntos -= 12;
            SilentWorker2.bonusRewarP = "1 RP";
        }
        Label_0466: {
            switch (this.tipoBono[0]) {
                case 0: {
                    if (this.finalPuntos >= 1200) {
                        this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[6]/div", "//button[@onclick=\"RedeemRPProduct('free_points_100')\"]", SilentWorker2.bonoRPFin);
                        this.finalPuntos -= 1200;
                        SilentWorker2.bonusRewarP = "100 RP";
                        break;
                    }
                    if (this.finalPuntos >= 600) {
                        this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[6]/div", "//button[@onclick=\"RedeemRPProduct('free_points_50')\"]", SilentWorker2.bonoRPFin);
                        this.finalPuntos -= 600;
                        SilentWorker2.bonusRewarP = "50 RP";
                        break;
                    }
                    if (this.finalPuntos >= 300) {
                        this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[6]/div", "//button[@onclick=\"RedeemRPProduct('free_points_25')\"]", SilentWorker2.bonoRPFin);
                        this.finalPuntos -= 300;
                        SilentWorker2.bonusRewarP = "25 RP";
                        break;
                    }
                    if (this.finalPuntos >= 120) {
                        this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[6]/div", "//button[@onclick=\"RedeemRPProduct('free_points_10')\"]", SilentWorker2.bonoRPFin);
                        this.finalPuntos -= 120;
                        SilentWorker2.bonusRewarP = "10 RP";
                        break;
                    }
                    SilentWorker2.bonoRPFin = " - ";
                    SilentWorker2.bonusRewarP = "No";
    ...
    protected void activarBonusFreeBTC() throws InterruptedException {
        ...
        if (this.finalPuntos >= 32 && this.finalPuntos < 160) {
            this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[4]/div", "//button[@onclick=\"RedeemRPProduct('fp_bonus_10')\"]", SilentWorker2.bonoBTCFin);
            this.finalPuntos -= 32;
            SilentWorker2.bonusFreeBTC = "10%";
        }
        switch (this.tipoBono[1]) {
            case 0: {
                if (this.finalPuntos >= 3200) {
                    this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[4]/div", "//button[@onclick=\"RedeemRPProduct('fp_bonus_1000')\"]", SilentWorker2.bonoBTCFin);
                    this.finalPuntos -= 3200;
                    SilentWorker2.bonusFreeBTC = "1000%";
                    break;
                }
                if (this.finalPuntos >= 1600) {
                    this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[4]/div", "//button[@onclick=\"RedeemRPProduct('fp_bonus_500')\"]", SilentWorker2.bonoBTCFin);
                    this.finalPuntos -= 1600;
                    SilentWorker2.bonusFreeBTC = "500%";
                    break;
                }
                if (this.finalPuntos >= 320) {
                    this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[4]/div", "//button[@onclick=\"RedeemRPProduct('fp_bonus_100')\"]", SilentWorker2.bonoBTCFin);
                    this.finalPuntos -= 320;
                    SilentWorker2.bonusFreeBTC = "100%";
                    break;
                }
                if (this.finalPuntos >= 160) {
                    this.activarBonos("//div[@id='rewards_tab']/div[4]/div/div[4]/div", "//button[@onclick=\"RedeemRPProduct('fp_bonus_50')\"]", SilentWorker2.bonoBTCFin);
                    this.finalPuntos -= 160;
                    SilentWorker2.bonusFreeBTC = "50%";
                    break;
                }
                SilentWorker2.bonoBTCFin = " - ";
                SilentWorker2.bonusFreeBTC = "No";
    ...
    protected void rollAction() throws IOException, InterruptedException, NoSuchSessionException {
        ...
        boolean invi;
        try {
            invi = SilentWorker2.driver.findElement(By.className("grecaptcha-badge")).isDisplayed();
        }
        ...
        SilentWorker2.responseToken = TwoCaptchaFreeBTC.Tokenizer();
        System.out.println(SilentWorker2.responseToken);
        if (SilentWorker2.responseToken.contains("ERROR_WRONG_USER_KEY")) {
            this.model.setValueAt(" 2Captcha API Key invalido", this.selector, 14);
            this.killDriver();
        }
        else if (SilentWorker2.responseToken.contains("ERROR_RECAPTCHA_TIMEOUT") & this.captchaCount >= 1) {
            do {
        ...
        else if (SilentWorker2.responseToken.contains("ERROR_PROXY_BANNED")) {
            do {
                final int range = this.model.getRowCount() - 0 + 1;
                this.proxySelector = (int)(Math.random() * range + 0.0);
            } while (this.proxySelector == this.selector);
        ...
        final JavascriptExecutor jse = (JavascriptExecutor)SilentWorker2.driver;
        if (invi) {
            System.out.println("Captcha invisible");
            jse.executeScript("document.getElementById('g-recaptcha-response').innerHTML='" + SilentWorker2.responseToken + "';", new Object[0]);
            jse.executeScript("window.submit_fp_rec_inv();", new Object[0]);
        }
        else {
            jse.executeScript("document.getElementById('g-recaptcha-response').value='" + SilentWorker2.responseToken + "';", new Object[0]);
            try {
                SilentWorker2.driver.findElement(By.linkText("Got it!")).click();
            }
            catch (NoSuchElementException ex) {}
            try {
                SilentWorker2.driver.findElement(By.id("free_play_form_button")).click();
            }
            catch (ElementNotInteractableException ex2) {}
        }
        SilentWorker2.balanceBTC = SilentWorker2.driver.findElement(By.id("balance")).getText();
        Thread.sleep(2000L);
        if (SilentWorker2.driver.findElement(By.id("free_play_error")).isDisplayed()) {
            if (SilentWorker2.driver.findElement(By.id("free_play_error")).getText().equals("Sorry, this IP address has been blocked. If you are using a proxy, VPN or anonymization service, please turn it off before claiming free bitcoins.")) {
                this.ipBaned();
            }
            else if (SilentWorker2.driver.findElement(By.id("free_play_error")).getText().equals("Captcha is incorrect or has expired. Please try again.")) {
                ++this.captchaCount;
                this.rollAction();
            }
            else if (SilentWorker2.driver.findElement(By.id("free_play_error")).getText().contains("You need to verify your email before you can play the FREE BTC game.")) {
        ...
        try {
            final WebDriverWait wait = new WebDriverWait(SilentWorker2.driver, 5L);
            ...
            Logger.getLogger(Worker.class.getName()).log(Level.SEVERE, null, e);
            SilentWorker2.driver.navigate().refresh();
            this.rollAction();
        }
        SilentWorker2.postRoll = SilentWorker2.driver.findElement(By.id("winnings")).getText();
        SilentWorker2.rewardPointRoll = SilentWorker2.driver.findElement(By.id("fp_reward_points_won")).getText();
        final int rp = Integer.parseInt(SilentWorker2.rewardPointRoll);
        this.finalPuntos += rp;
    ...
    protected void postear() throws InterruptedException, NoSuchSessionException {
        ...
        double finall = 0.0;
        final double balanceParse = Double.parseDouble(SilentWorker2.balanceBTC);
        if (!SilentWorker2.postRoll.isEmpty()) {
            final double balroll = Double.parseDouble(SilentWorker2.postRoll);
            finall = (balanceParse + balroll) * 1.0E8;
            final int balance2 = (int)finall;
            this.model.setValueAt(String.format("%,d", balance2), this.selector, 2);
            this.balanceRoll = SilentWorker2.postRoll.replace(".", "0");
        ...
        this.model.setValueAt(SilentWorker2.rewardPointRoll, this.selector, 6);
        this.model.setValueAt(SilentWorker2.bonoRPFin, this.selector, 9);
        this.model.setValueAt(SilentWorker2.bonoBTCFin, this.selector, 12);
        this.model.setValueAt(SilentWorker2.bonusRewarP, this.selector, 8);
        this.model.setValueAt(SilentWorker2.bonusFreeBTC, this.selector, 11);
    ...
    protected void ipBaned() throws NoSuchSessionException {
        int balance2;
        if (!SilentWorker2.balanceBTC.isEmpty()) {
            final double balanceParse = Double.parseDouble(SilentWorker2.balanceBTC) * 1.0E8;
    ...
    protected void freeRollPlay() throws NoSuchSessionException, InterruptedException, IOException {
        ...
        try {
            SilentWorker2.driver.findElement(By.className("g-recaptcha"));
            this.rollAction();
        }
        catch (NoSuchElementException e) {
            this.sinCaptpcha();
    ...
    public void activarBonos(final String banner, final String bono, String tipoBono) {
        SilentWorker2.driver.findElement(By.linkText("REWARDS")).click();
        SilentWorker2.driver.findElement(By.xpath(banner)).click();
        SilentWorker2.driver.findElement(By.xpath(bono)).click();
        tipoBono = "24 Hrs";
    }
    
    static {
        SilentWorker2.balancePuntos = "";
        SilentWorker2.balancePuntosParse = 0;
        SilentWorker2.balanceBTC = "";
        SilentWorker2.bonoRPFin = " - ";
        SilentWorker2.bonoBTCFin = " - ";
        SilentWorker2.postRoll = "";
        SilentWorker2.rewardPointRoll = "";
    }
}
